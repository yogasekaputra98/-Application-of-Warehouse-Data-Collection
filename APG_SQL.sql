...
INSERT INTO `list_barang` (`id_barangG`, `nama_barang`, `nama_kategori`, `harga_barang`, `nama_supplier`) VALUES
('BG002', 'Teh Box', 'Minuman', 3500, 'PT. Mundur Jaya'),
('BG003', 'Apel Fuji 1ons', 'Buah-buahan', 3000, 'PT. Mundur Jaya'),
('BG004', 'Sayur Kol 1kg', 'Sayuran', 8000, 'PT. Mundur Jaya'),
('BG001', 'Mie Instan', 'Makanan', 3000, 'CV. Tronjal Tronjol'),
('BG005', 'Garam 1ons', 'Bumbu dapur', 3000, 'CV. Tronjal Tronjol'),
('BG009', 'Pensil 2B', 'Alat tulis', 3500, 'CV. Tronjal Tronjol'),
('BG006', 'Terminal', 'Alat elektronik', 18000, 'PT. Bubat Kerja'),
('BG011', 'Obat Demam', 'Obat-obatan', 2500, 'PT. Bubat Kerja'),
('BG014', 'Topi', 'Pakaian', 20000, 'PT. Bubat Kerja'),
('BG007', 'Gula Pasir 1kg', 'Sembako', 12000, 'PT. BE Adil Makmur'),
('BG008', 'Sabun Mandi', 'Peralatan mandi', 2000, 'PT. BE Adil Makmur'),
('BG015', 'Rokok 12btg', 'Lainnya', 12000, 'PT. BE Adil Makmur'),
('BG010', 'Sabun Cuci', 'Peralatan cuci', 2000, 'PT. Dago Bermartabat'),
('BG012', 'Popok Bayi XL', 'Peralatan bayi', 50000, 'PT. Dago Bermartabat'),
('BG013', 'Majalah Anak', 'Bacaan', 5000, 'PT. Dago Bermartabat');
...
INSERT INTO `list_pegawai` (`nama`, `alamat`, `nama_job`) VALUES
('Fadhillah', 'Baleendah', 'Gudang'),
('Yogas', 'Garut', 'Manajer'),
('Vita', 'Ciparay', 'Minimarket'),
('Avelisa', 'Medan', 'Logistik'),
('Nurhadi', 'Kudus', 'Direktur'),
('Fulan', 'Wakanda', 'Office Boy');
